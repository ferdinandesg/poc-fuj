...
export default function CardForm({ document }: CardFormProps) {
    ...
    return <div>
        {isLoading && <div className="absolute w-screen h-screen bg-black bg-opacity-25 flex items-center justify-center"> <Loader size={96} color="white" fill="white" className="animate-spin" /> </div>}
