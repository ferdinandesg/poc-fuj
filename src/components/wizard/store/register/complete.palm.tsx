...
import { Contact2, CreditCard, Hand } from "lucide-react";
...
export default function CompletePalmWizard({ document }: CompleteWizardProps) {
    ...
    const STEPS: Step[] = [
        ...
        { step: 2, label: "Biometria", icon: <Hand /> },
